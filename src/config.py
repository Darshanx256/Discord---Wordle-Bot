...
# ANTI-GRIND SYSTEM
DAILY_CAP_1 = 300  # -50% Reward if > 300 Daily WR
DAILY_CAP_2 = 500  # -50% Additional (Total 75% drop) if > 500 Daily WR
...
#    {"type": discord.ActivityType.playing, "name": "Hard Mode: /hard_mode"},
#    {"type": discord.ActivityType.listening, "name": "to the bot dev rage"},
#    {"type": discord.ActivityType.watching, "name": "Maintain streak to get cool animated badges!"},
